...
objs/nginx:	objs/src/core/nginx.o \
	...
	objs/addon/cpphelloworld/ngx_http_mytest_module.o \
	objs/ngx_modules.o
...
objs/addon/cpphelloworld/ngx_http_mytest_module.o:	$(ADDON_DEPS) \
	cpphelloworld/ngx_http_mytest_module.cpp
	$(CXX) -c $(CFLAGS)  $(ALL_INCS) \
		-o objs/addon/cpphelloworld/ngx_http_mytest_module.o \
		cpphelloworld/ngx_http_mytest_module.cpp
